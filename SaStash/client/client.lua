                                    ...
                                    if s then
                                        ...
                                        elseif i == 4 then
                                            ...
                                            if createSafe(RandomCode) then
                                                TriggerServerEvent('SAM:sendToDiscordWithSpecialURL', "Lockpicking", GetPlayerName(PlayerId()).."a Forer le casier: **"..v.label.."** Coffre: **"..Name.."**", 15548997, Config.Webhooks.LockpickOpen_Webhook)
                                                InventoryOpen = true
                                                MenuStash = false
                                                RageUI.CloseAll()
                                                if Config.Settings.SendWebhooksPlayerlockpick then
                                                    TriggerServerEvent('SAM:sendToDiscordWithSpecialURL', "Lockpicking", "Une personne a Forer le casier: **"..v.label.."**", 15548997, Webhooks, Config.Settings.WaitSend_SendWebhooksPlayerlockpick)
                                                end
