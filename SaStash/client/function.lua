...
function OpenInventory(value, stash, chest, Webhooks)
    ...
    TriggerServerEvent('SAM:sendToDiscordWithSpecialURLStaff', Config.Lang.Webhooks_Open_title, string.format(Config.Lang.Webhooks_Open2, GetPlayerName(PlayerId()), stash, chest), 5793266, "open")
